            ...
            <div class="row">
                            ...
                            <table class="table table-hover shopping-cart-wrap">
                                ...
                                @foreach(\Cart::getContent() as $item)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('checkout.cart.remove', $item->id) }}" class="btn btn-outline-danger">
                ...
                <aside class="col-sm-3">
                    ...
                    <figure class="itemside mb-3">
                        <aside class="aside">
                            <img src="{{ asset('frontend/images/icons/pay-visa.png') }}">
                        </aside>
                    ...
                    <figure class="itemside mb-3">
                        <aside class="aside"> 
                            <img src="{{ asset('frontend/images/icons/pay-mastercard.png') }}"> 
                        </aside>
                        <div class="text-wrap small text-muted">
